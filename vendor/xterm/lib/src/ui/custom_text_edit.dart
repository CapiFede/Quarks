...
class CustomTextEditState extends State<CustomTextEdit> with TextInputClient {
  ...
  void _openInputConnection() {
    ...
    if (hasInputConnection) {
      ...
      // Patched: pass the FlutterView ID so the platform side knows which
      // view this input belongs to. Without it, Flutter 3.27+ throws
      // "PlatformException(Bad Arguments, Could not set client, view ID is
      // null.)" which corrupts text input app-wide.
